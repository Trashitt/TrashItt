...
const leaderboardData = [
  { rank: 1, name: 'Ruchi Sharma', points: 2840, badge: 'Planet Hero', avatar: 'RS', trend: 'up', scans: 156, college: 'YSM Dhurwa' },
  { rank: 2, name: 'Amit Verma', points: 2650, badge: 'Planet Hero', avatar: 'AV', trend: 'up', scans: 143, college: 'Xavier\'s Ranchi' },
  { rank: 3, name: 'Sneha Kumari', points: 2410, badge: 'Eco Champion', avatar: 'SK', trend: 'same', scans: 128, college: 'DSPMU Ranchi' },
  ...
  { rank: 7, name: 'Uttam Jha', points: 1690, badge: 'Eco Champion', avatar: 'UJ', trend: 'same', scans: 91, college: 'YSM Dhurwa' },
  ...
  { rank: 13, name: 'Sunita Munda', points: 1100, badge: 'Green Warrior', avatar: 'SM', trend: 'down', scans: 59, college: 'DSPMU Ranchi' },
  { rank: 14, name: 'Trisha Singh', points: 1020, badge: 'Green Warrior', avatar: 'TS', trend: 'up', scans: 54, college: 'YSM Dhurwa' },
  ...
  { rank: 18, name: 'Arun Ekka', points: 720, badge: 'Green Warrior', avatar: 'AE', trend: 'up', scans: 38, college: 'YSM Dhurwa' },
  ...
  { rank: 21, name: 'Suman Devi', points: 510, badge: 'Eco Starter', avatar: 'SD', trend: 'down', scans: 27, college: 'DSpmu Ranchi' },
  { rank: 22, name: 'Prakash Nag', points: 450, badge: 'Eco Starter', avatar: 'PN', trend: 'up', scans: 24, college: 'Gossner College' },
  { rank: 23, name: 'Manjeet Kumar', points: 340, badge: 'Green Warrior', avatar: 'MK', trend: 'up', scans: 42, college: 'YSM Dhurwa', isUser: true },
  { rank: 24, name: 'Geeta Munda', points: 280, badge: 'Eco Starter', avatar: 'GM', trend: 'same', scans: 15, college: 'YSM Dhurwa' },
